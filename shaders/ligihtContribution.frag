...
void main() {
  ...
  // float current_depth =
  //     clamp(-1.0, 1.0, ndc_pos.z * 0.5 + 0.5 - 0.0005 / clip_pos.w);
  ...
  //   }
  // }
  // float lightpcf = 1.0 - light_d / 49.0;
  ...
  // light_diffuse_contribution =
  //     vec4(diffuse * lightpcf * angle_falloff * distance_falloff *
  //              light_angle_falloff * light_intensity,
  //          1.0);
  // light_diffuse_contribution = vec4(1.0);
  // light_specular_contribution =
  //     vec4(specular * lightpcf * angle_falloff * distance_falloff *
  //              light_angle_falloff * light_intensity,
  //          1.0);
  // light_ambient_contribution =
  //     vec4(ambient * lightpcf * angle_falloff * distance_falloff *
  //              light_angle_falloff * light_intensity,
  //          1.0);
  // light_specular_contribution = vec4(1.0);
  // light_diffuse_contribution = vec4(1.0);
  // light_ambient_contribution = vec4(1.0);
  frag_color = vec4(1.0);
}
